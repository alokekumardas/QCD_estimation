...
if finalState=="Mu":
	...
	#analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples_METfilter/%s/"%selYear # need to change to 2017 or sth else
	...
	#analysisNtupleLocation =  "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples_METfilter/%s/"%selYear
	...
	#analysisNtupleLocation =  "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples/QCD_controlRegion_lepveto/%s/QCDcr_"%selYear
	#analysisNtupleLocation =  "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples_METfilter/QCD_controlRegion_lepveto/%s/QCDcr_"%selYear
	...
	#analysisNtupleLocation =  "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples/QCD_controlRegion_lepveto/%s/"%selYear
	#analysisNtupleLocation =  "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples_METfilter/QCD_controlRegion_lepveto/%s/"%selYear
...
if not "QCD_DD" in sample:
	...
	for hist in histogramsToMake:
		...
		if ('Data' in sample ) and not h_Info[5]: continue
